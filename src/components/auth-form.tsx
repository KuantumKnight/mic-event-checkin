...
export function AuthForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (forgot) {
      ...
      setBusy(false); setMessage(result.error ? result.error.message : "If that account exists, a reset link is on its way."); return;
    }
